...
import ReviewPage from "./slide-review";
...
import cdgLogo from "../Images/White-images/home-page-white/header-white/CDG.svg";
import jobintechLogo from "../Images/White-images/home-page-white/header-white/jobintech-logo-new.png";
import ministerLogo from "../Images/White-images/home-page-white/header-white/minister de la transition numerique icon.svg";
import orangeLogo from "../Images/White-images/home-page-white/header-white/Orange_logo.svg";
...
const partnerLogos = [
  { src: cdgLogo, alt: "CDG" },
  { src: jobintechLogo, alt: "Jobintech" },
  { src: ministerLogo, alt: "Ministere de la Transition Numerique" },
          ...
          <div className="mx-auto flex w-full max-w-[1240px] flex-col items-center justify-center px-6 py-10 text-center sm:py-12">
            ...
            <div className="mb-5 flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
              <div className="flex -space-x-2">
                ...
                <div className="h-6 w-6 rounded-full border-2 border-white bg-blue-400 dark:border-neutral-900" />
              </div>
          ...
          <section className="bg-white dark:bg-neutral-950 px-8 py-16">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 flex flex-col gap-5">
                ...
                <h2 className="text-[28px] sm:text-[32px] font-extrabold text-gray-900 dark:text-white leading-tight">
                  Chat, quizzes, and more!
                </h2>
                <p className="text-[14px] text-gray-500 dark:text-gray-400 leading-relaxed">
                  Identify core concepts, validate your progress with assessments, access cited answers, and engage with an interactive AI tutor.
                </p>
                <button
                  onClick={() => navigate("/auth")}
              ...
              <div className="flex-1 relative flex items-center justify-center w-full min-h-[380px]">
                <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-56 sm:w-64 rounded-2xl overflow-hidden shadow-lg border border-gray-200 dark:border-neutral-700">
                  <img src={info2} alt="Quiz sidebar" className="w-full h-auto" />
                </div>
                <div className="relative z-20 w-full max-w-md rounded-2xl overflow-hidden shadow-2xl border-2 border-green-400 dark:border-green-500">
                  <img src={info} alt="Chat UI" className="w-full h-auto" />
                </div>
              </div>
            </div>
          </section>
